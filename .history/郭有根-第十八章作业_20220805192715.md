[//]: # (注释
  ...
  LastEditors: gyg
  LastEditTime: 2022-08-05 19:26:42
  FilePath: \note\郭有根-第十八章作业.md
)
...
4. 请说一下JDK8中接口的静态方法和默认方法的区别
    ...
    - 默认方法在接口和实现类上调用；静态方法 通过 接口名.方法名  调用
...
![2022年08月05日19点24分24秒179毫秒-javalearncode_–_Poker.java_Administratoridea64.png](https://s2.loli.net/2022/08/05/K7duOsfygWXxr9w.png)
...
![2022年08月02日14点27分57秒355毫秒.png](https://s2.loli.net/2022/08/02/oYsf96wMy2enQIb.png)